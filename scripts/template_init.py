...
3. Replaces all instances of "iplot" with the module name
4. Renames the src/iplot directory to src/{modulename}
...
def main():
    ...
    if module_name == "iplot":
        print("Module name is already 'iplot', no changes needed.")
        return
    ...
    for file_path in files_to_process:
        if find_and_replace_in_file(file_path, "iplot", module_name, args.dry_run):
            files_changed += 1
    ...
    if rename_directory("iplot", module_name, args.dry_run):
